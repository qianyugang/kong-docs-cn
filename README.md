...
**重要❗️：** 本文档是基于  [![](https://img.shields.io/badge/Kong-1.0.x-inactive)](https://legacy-gateway--kongdocs.netlify.app/gateway-oss/1.0.x/)  版本，目前官网已经更新至  [![](https://img.shields.io/badge/Kong-3.3.x-green)](https://docs.konghq.com/gateway/3.3.x/)  版本，如果使用的其他版本，请查看官方文档：
